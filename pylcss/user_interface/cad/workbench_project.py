...
class WorkbenchProjectMixin:
    ...
    def _request_modeling_function(self) -> None:
        """Persist the active study and hand it to the Modeling Environment."""
        ...
        self.statusBar().showMessage(
            "Choose simulation inputs and results for the Modeling Environment."
        )
