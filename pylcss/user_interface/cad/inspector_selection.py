...
class SelectionInspectorMixin:
    def _build_select_face_ui(self, node):
        ...
        entity_combo.setToolTip(
            "Faces define distributed loads such as pressure. Edges and "
            "vertices are useful for line/point supports and concentrated forces."
        )
    ...
    def _start_picking_session(self, node):
        ...
        if entity_type == "Edge":
            ...
            viewer.enable_edge_picking_mode(multi_select=True)
