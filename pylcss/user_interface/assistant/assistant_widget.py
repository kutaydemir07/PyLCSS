...
class AssistantWidget(QWidget):
    """
    Main widget for assistant control settings and monitoring.
    ...
    def __init__(self, manager: AssistantManager, parent: Optional[QWidget] = None):
        """
    ...
    def _on_llm_config_saved(self) -> None:
        ...
        from pylcss.assistant_systems.config import AssistantConfig
        new_config = AssistantConfig.load()
    ...
    def _open_llm_chat_dialog(self) -> None:
        ...
        from .llm_chat_dialog import LLMChatDialog
    ...
    def _check_voice_model(self) -> None:
        ...
        from pylcss.assistant_systems.services.voice import VoiceController, VOSK_AVAILABLE
