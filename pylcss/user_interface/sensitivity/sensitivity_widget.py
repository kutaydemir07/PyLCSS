...
from ..common.theme_manager import COLORS, set_filled_button_icon
...
class SensitivityAnalysisWidget(QtWidgets.QWidget):
    ...
    def setup_ui(self):
        ...
        set_filled_button_icon(self.btn_refresh_outputs, "fa5s.sync")
        ...
        # 4. Action Buttons
        self.btn_analyze = QtWidgets.QPushButton(" Run Sensitivity Analysis")
        set_filled_button_icon(self.btn_analyze, "fa5s.chart-bar")
        ...
        set_filled_button_icon(self.btn_export, "fa5s.download")
