...
class CustomBlockNode(BaseNode):
    ...
    def _refresh_function_summary(self):
        ...
        if "cad.impact(" in code or "cad.crash(" in code:
            execution = "Design Studio · Impact"
...
_SYSTEM_NODE_TOOLTIPS = {
    ...
    "com.pfd.custom_block": (
        ...
        "or a linked Design Studio FEA, impact, or TopOpt study. Double-click to edit."
    ),
    "com.pfd.output": (
...
def apply_system_node_style(node) -> None:
    ...
    if current_theme() == "light":
        color, border, text = LIGHT_SYSTEM_NODE_PALETTES.get(
            identifier,
            ((247, 248, 250, 255), border, (52, 64, 84, 255)),
        )
