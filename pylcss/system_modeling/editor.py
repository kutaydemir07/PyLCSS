...
from .model_compilation import get_compiled_code
from .graph_input_output import save_graph, load_graph
...
class ModelingWidget(QtWidgets.QWidget):
    ...
    def save_graph_to_file(self, folder_path):
        ...
        import os
        from .graph_input_output import save_graph_to_file
    ...
    def load_graph_from_file(self, folder_path):
        ...
        import os
        from .graph_input_output import load_graph_from_file
        path = os.path.join(folder_path, 'systems.json')
