...
class MouseController:
    ...
    def __init__(self) -> None:
        ...
        if not PYAUTOGUI_AVAILABLE:
            raise ImportError(
                "PyAutoGUI could not initialize; desktop input control is unavailable"
    ...
    def click(self, button: str = "left", clicks: int = 1) -> None:
        ...
        try:
            ...
            logger.debug("Clicked %s x%d", button, clicks)
        except pyautogui.FailSafeException:
    ...
    def scroll_horizontal(self, clicks: int) -> None:
        ...
        if not hasattr(pyautogui, "hscroll"):
            raise RuntimeError("Horizontal scrolling is not supported on this platform")
    ...
    def write_text(self, text: str) -> None:
        ...
        try:
            ...
            try:
                ...
                logger.warning("Could not restore the clipboard", exc_info=True)
