...
class LLMControlConfig:
    ...
    # Conversation content is stored locally in plaintext when enabled.
    # Make retention an explicit opt-in for new installations.
    memory_enabled: bool = False
    max_memory_messages: int = 20

    agentic_mode: bool = True
    cloud_data_notice_acknowledged: bool = False
    ...
    def __post_init__(self) -> None:
        ...
        self.memory_enabled = _read_bool(self.memory_enabled, False)
        self.agentic_mode = _read_bool(self.agentic_mode, True)
        self.cloud_data_notice_acknowledged = _read_bool(
            self.cloud_data_notice_acknowledged,
            False,
        )
