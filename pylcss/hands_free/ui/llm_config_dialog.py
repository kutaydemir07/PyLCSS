...
from pylcss.hands_free.llm_memory import get_secure_storage, LLMMemory
...
class LLMConfigDialog(QDialog):
    ...
    def _setup_ui(self) -> None:
        ...
        tabs.addTab(self._create_generation_tab(), "⚙️ Generation")
    ...
    def _create_provider_tab(self) -> QWidget:
        ...
        for provider_name in get_available_providers():
            ...
            self.active_provider_combo.addItem(f"{icon} {display_name}", provider_name)
    ...
    def _create_memory_tab(self) -> QWidget:
        ...
        # Clear memory button
        clear_btn = QPushButton("🗑️ Clear All Memory")
    ...
    def _update_memory_stats(self) -> None:
        ...
        try:
            ...
            self.memory_stats.setText(f"📊 {count} conversations stored")
        except Exception as e:
