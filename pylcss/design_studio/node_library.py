...
from pylcss.design_studio.nodes import (
    ...
    # FEA / Simulation.
    MaterialNode, MeshNode, FEAComponentNode, ConstraintNode, LoadNode, PressureLoadNode,
    SolverNode, TopologyOptVoxelNode,

    # Crash / Impact.
    ImpactConditionNode, CrashSolverNode,
...
NODE_CLASS_MAPPING = {
    ...
    'com.cad.sim.component':      FEAComponentNode,
    'com.cad.sim.constraint':     ConstraintNode,
    'com.cad.sim.load':           LoadNode,
    # Palette preset; serializes as the existing LoadNode for compatibility.
    'com.cad.sim.gravity':        LoadNode,
    'com.cad.sim.pressure_load':  PressureLoadNode,
    'com.cad.sim.solver':         SolverNode,
    'com.cad.sim.topopt_voxel':    TopologyOptVoxelNode,
    'com.cad.sim.lattice_voxel':   LatticeOptVoxelNode,
    'com.cad.sim.lattice_infill':  LatticeInfillNode,
    'com.cad.topopt.support':       TopologySupportNode,
    'com.cad.topopt.load':          TopologyLoadNode,

    # Crash / Impact Simulation. Impact material is part of the shared
    # Material node; `crash_material` maps onto it so saved studies still load.
    'com.cad.sim.crash_material': MaterialNode,
