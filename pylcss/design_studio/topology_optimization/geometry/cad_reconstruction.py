...
"""Topology optimization export: recovered surface mesh -> stronger STEP B-rep.

The public reconstruction entry point and node identifier are stable, while
this geometry-layer implementation improves STEP output quality by adding:
